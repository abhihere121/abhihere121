    ...
    return (
        <>
            <div style={drawerStyle}>
                <div style={{ padding: '24px', display: 'flex', alignItems: 'center', gap: '12px', borderBottom: `1px solid ${mdTheme.colors.outlineVariant}` }}>
                    <div style={{
                        ...
                        <span style={{ color: mdTheme.colors.onPrimary, fontWeight: 'bold', fontSize: '18px' }}>R</span>
                    </div>
                    <span style={{ fontSize: '20px', fontWeight: 600, letterSpacing: '0.5px', color: mdTheme.colors.onSurfaceVariant }}>RESTIQ</span>
                </div>
